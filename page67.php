...
//           echo json_encode($arr2);
	  ...
	  //yli14 10_9
           if($arr1['board'] == $arr2['board'] && $arr1['mp'] == $arr2['mp'] && $arr1['bits'] == $arr2['bits'] && ($arr2['board'] != null) && ($arr1['board'] != null))
           //if($arr1['board'] == $arr2['board'] && $arr1['bsp'] == $arr2['bsp'] && $arr1['mp'] == $arr2['mp'] && $arr1['bits'] == $arr2['bits'])
           {
